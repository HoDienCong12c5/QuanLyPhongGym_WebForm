...
<PagerSettings EnableAdaptivity="True">
    <Summary Text="Trang {0} của {1}" />
                ...
                <ItemTemplate>
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <br />
                    <asp:ImageButton ID="btnXemThem" CssClass="xemthem" runat="server" Height="50px" OnClick="btnXemThem_Click" Width="115px" ImageUrl="~/image_nguoidung/AnhChucNang/dang_ky_bai_tap_ngay.gif" />
                </div>
                        </ItemTemplate>
